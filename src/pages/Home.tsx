  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-walmart-gray-light/20">
      ...
      <section className="bg-gradient-to-r from-walmart-gray-light via-background to-walmart-gray-light relative overflow-hidden">
        <div className="absolute inset-0 bg-[url(`data:image/svg+xml,%3Csvg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="%23fbbf24" fill-opacity="0.03"%3E%3Cpath d="M20 20c0-5.5-4.5-10-10-10s-10 4.5-10 10 4.5 10 10 10 10-4.5 10-10zm10 0c0-5.5-4.5-10-10-10s-10 4.5-10 10 4.5 10 10 10 10-4.5 10-10z"/%3E%3C/g%3E%3C/svg%3E`)]"></div>
        <div className="container mx-auto px-4 py-12">
